...
const ManageTopics = ({navigation , route}) => {
    ...
    <Text style={styles.font} className="block text-black font-bold mb-2 text-2xl"  >
      ...
      {citiesArray && citiesArray.length !== 0 ? citiesArray.map((item , index) => (
        ...
        className="mt-3 text-black py-3 bg-gray-800 hover:bg-gray-900 rounded-lg text-sm px-6  mb-2 w-full"
          style={styles.button}
          onPress={() => navigation.navigate('AddTopicDashboard')}>
          <Text style={styles.buttonText}> إضافة موضوع </Text>
        </TouchableOpacity>
...
<View style={styles.modalContainer} >
  ...
  {error && (
        ...
        {success && (
          ...
          <Text className="text-black text-center text-lg mb-5" style={styles.font} > الاجرائات على الموضوع  </Text>
      ...
      <TouchableOpacity
        className="mt-2 text-center text-black py-3 bg-green-400  rounded-lg text-sm px-6  mb-2 w-full"
          ...
          onPress={() =>  {
            setModalVisible(!modalVisible);
            navigation.navigate('EditTopicDashboard' , {
    editId : editId,
   } );


          } }>
          <Text style={styles.buttonText}>   تعديل الموضوع   </Text>
        </TouchableOpacity>
      ...
      <TouchableOpacity
        className="mt-2 text-center text-black py-3 bg-red-400  rounded-lg text-sm px-6  mb-2 w-full"
          style={styles.buttonBG}
          onPress={() => {
            deleteRecord("topics" , editId);
          } }>
          <Text style={styles.buttonText}>   حذف الموضوع   </Text>
        </TouchableOpacity>
