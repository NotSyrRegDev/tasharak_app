...
const AddCategory = ({navigation , route}) => {
  ...
  const { addCategory , error  , success , setError , uploadImage  } = useContext(AdminContext);
  ...
  const handleAddCateogry = () => {
    setIsLoading(true);
    addCategory( categoryName , actorThum , () => {
  ...
  contentContainerStyle={{ flexGrow: 1 }} 
    ...
    <Text style={styles.textInput} className="block text-gray-700 font-bold mb-2" htmlFor="username">
      اسم التصنيف   <Text className="text-red-500 text-base text-right" > * </Text>  
    </Text>
  ...
  أيقونة التصنيف 
    ...
    <TouchableOpacity
            ...
            style={styles.uploadButton}
              ...
              <Text style={styles.buttonTextBlack}>   اختيار الصورة </Text>
            </TouchableOpacity>
